...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib mgllib.lib Strmbase.lib /nologo /subsystem:windows /machine:I386 /out:"bin/mgl_test.exe" /libpath:"..\lib"
...
# ADD CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /I "..\include\mgl_header" /I "..\msl\include" /I "..\mwl\include" /I "..\agh\include" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /FR /Yu"stdafx.h" /FD /GZ /c
