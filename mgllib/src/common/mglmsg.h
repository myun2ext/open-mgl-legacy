...
#define MGLMSGNO_GRPMGR(NO)		(MGLMSGNO_GRP(0x100000)+(NO))
#define MGLMSGNO_IMAGE(NO)		(MGLMSGNO_GRP(0x200000)+(NO))	//	NO = 000～FFF
#define MGLMSGNO_TEXT(NO)		(MGLMSGNO_GRP(0x320000)+(NO))
#define MGLMSGNO_DRAW_LINE		(MGLMSGNO_GRP(0x790000))
#define MGLMSGNO_BITMAP_DATA	(MGLMSGNO_GRP(0x800000))

//	3Dグラフィックス
#define MGLMSGNO_MATRIX(NO)		(MGLMSGNO_3D(0x100000)+(NO))
#define MGLMSGNO_LIGHT(NO)		(MGLMSGNO_3D(0x200000)+(NO))
#define MGLMSGNO_SHADER(NO)		(MGLMSGNO_3D(0x300000)+(NO))
...
#define MGLMSGNO_IMAGE_FILE_NOT_FOUND			(MGLMSGNO_IMAGE(55))
