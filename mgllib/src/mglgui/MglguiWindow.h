...
typedef bool (CMglguiWindow::*MGL_KB_EVT_HANDLER_CALLBACK)();
typedef struct {
...
//	クラス宣言  /////////////////////////////////////////////////////////
class DLL_EXP CMglguiWindow : public agh::CScreenBase, public CMyuThreadBase, protected CMglEzGameFrame
{
protected:
...
public:
	//	コンストラクタ
	CMglguiWindow() : m_mouse(input.mouse), m_grp(grp), m_input(input) {
		m_hWnd = NULL;
...
//class DLL_EXP CMglguiWindow : public CMglguiWindow
class DLL_EXP CMglguiWindow : public CMglguiWindow, public agh::CWindowBase
{
private:
protected:
