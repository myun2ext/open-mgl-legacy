...
private:
	...
	CMglguiScreenHitTest *m_pHitTestMap;
...
class DLL_EXP CMglguiScreenHitTest
{
private:
	CMglGraphicManager* m_myudg;	//	CMglGraphicManagerへのポインタを格納
	D3DCOLOR* m_pHistTestMap;
public:
	CMglguiScreenHitTest(CMglGraphicManager* in_myudg=g_pDefaultGd){Init(in_myudg);}
	virtual ~CMglguiScreenHitTest(){Release();}
