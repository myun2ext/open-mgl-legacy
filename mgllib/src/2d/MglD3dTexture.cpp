...
//	新・描画方式
void CMglD3dTexture::Draw(float x, float y, D3DCOLOR color )
{
	//	頂点初期情報取得
...
//	描画（二次元固定）
void CMglD3dTexture::Draw( MGL_SQUARE_VERTEXS *pMglSqVertexs, BOOL bVertexRevise )
{
	Draw( (MYU_VERTEX*)pMglSqVertexs, 2, bVertexRevise );
}

//	描画（頂点数不定）
void CMglD3dTexture::Draw( MYU_VERTEX *pMyuVertex, UINT nPrimitiveCount, BOOL bVertexRevise )
{
...
//	DrawPrimitiveUP
void CMglD3dTexture::DrawPrimitiveUP( D3DPRIMITIVETYPE primitiveType, UINT nPrimitiveCount,
...
void CMglD3dTexture::TextureDraw(
