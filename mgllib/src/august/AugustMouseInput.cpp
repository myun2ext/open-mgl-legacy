...
//	staticな変数の実体
int CAugustMouseCore::m_keyCodeTable[AUGUST_KEYCODE_TABLE_SIZE];
bool CAugustMouseCore::m_bKeyCodeTableInited = false;

////////////////////////////////////////////////////////////////////////

//	テーブルの生成
void CAugustMouseCore::GenKcTable()
{
