...
//	キーボードイベントハンドラ構造体
class CAugust3dManager;
typedef bool (CAugust3dManager::*AUGUST_KB_EVT_HANDLER_CALLBACK)();
typedef struct {
...
//	クラス宣言  /////////////////////////////////////////////////////////
class DLL_EXP CAugust3dManager : public agh::CScreenBase
{
protected:
...
public:
	//	コンストラクタ
	/*CAugust3dManager(CAugustGlobalCommon &g_in) : g_(g_in),
