...
void CAugustKeyboardInput::OnDraw()
{
	g_->pGrp->Clear(m_rgbBackground);	//	2008/11/29 CAugustKeyboardInput対応
...
//	フレーム処理
bool CAugustKeyboardInput::DoFrame()
{
...
/*
void CAugustKeyboardInput::RegistControl(CMglAghImage* pImage)
{
...
void CAugustKeyboardInput::RegistControl(CAugustVisualControlBase* pControl)
{
...
void CAugustKeyboardInput::RegistControl(CAugustVisualControlBase2* pControl)
{
	pControl->OnRegist(g_);
...
/*void CAugustKeyboardInput::RegistControl(CControlBase* pControl)
{
...
void CAugustKeyboardInput::RegistSubControl(CAugustCtrlBase* pControl)
{
...
/*void CAugustKeyboardInput::RegistControl(agh::CControlBase* pControl)
{
	pControl->OnRegist(g_);
...
void CAugustKeyboardInput::_RegistControlInternal(agh::CControlBase* pCtrl)
{
