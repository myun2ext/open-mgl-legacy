...
#include "mwlagh.h"
	...
	#define _AGST_DLL_TMPL_EXP template class _AGST_DLL_EXP			//	C4275ëŒâû
	//#define DLL_TMPL_EXTERN
	//#define DLL_TMPL_EXTERN template
#else
	#define _AGST_DLL_EXP __declspec(dllimport)
	#define _AGST_DLL_TMPL_EXP /*extern*/ template class _AGST_DLL_EXP	//	C4275ëŒâû
...
#define AUGUST_VALKEY_					(AGH_VALKEY_USER_FIRST+0x18A60000)	//	îÌÇÁÇ»Ç≥ÇªÇ§Ç…ìKìñÇ»êîéöÅB18A6
