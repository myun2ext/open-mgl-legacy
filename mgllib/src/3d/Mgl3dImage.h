...
public:
	void Draw(float x=0.0f, float y=0.0f, float z=0.0f, RECT* srcRect=NULL, float fTexScaleX=1.0f, float fTexScaleY=1.0f,
		D3DCOLOR color=D3DCOLOR_WHITE);

	void SetupVertexes(float x=0.0f, float y=0.0f, float z=0.0f, RECT* srcRect=NULL, float fTexScaleX=1.0f, float fTexScaleY=1.0f,
		D3DCOLOR color=D3DCOLOR_WHITE);
};
