...
# ADD CPP /nologo /MD /W3 /GX /O2 /I "src" /I "src/august" /I "src/2d" /I "src/3d" /I "src/graphic_extends" /I "src/common" /I "src/window" /I "src/game" /I "src/input" /I "src/audio" /I "src/mglgui" /I "vox" /I "../MSL/include" /I "../MWL/include" /I "../MWL/mwlagh" /I "../AGH/include/" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "MGLLIB_EXPORTS" /FR /Yu"stdafx.h" /FD /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib mwlagh.lib /nologo /dll /machine:I386 /out:"../bin/Release/mgllib.dll" /implib:"../lib/mgllib.lib" /libpath:"../lib"
...
# ADD CPP /nologo /MDd /W3 /Gm /GX /ZI /Od /I "src" /I "src/august" /I "src/2d" /I "src/3d" /I "src/graphic_extends" /I "src/common" /I "src/window" /I "src/game" /I "src/input" /I "src/audio" /I "src/mglgui" /I "vox" /I "../MSL/include" /I "../MWL/include" /I "../MWL/mwlagh" /I "../AGH/include/" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "MGLLIB_EXPORTS" /FR /Yu"stdafx.h" /FD /GZ /c
...
# ADD LINK32 kernel32.lib user32.lib gdi32.lib winspool.lib comdlg32.lib advapi32.lib shell32.lib ole32.lib oleaut32.lib uuid.lib odbc32.lib odbccp32.lib mwlagh_d.lib /nologo /dll /debug /machine:I386 /out:"../bin/Debug/mgllib.dll" /implib:"../lib/mgllib.lib" /pdbtype:sept /libpath:"../lib"
# SUBTRACT LINK32 /pdb:none
...
SOURCE=.\src\august\AugustCommon2.h
# End Source File
# Begin Source File

SOURCE=.\src\august\AugustGraphicsManager.cpp
# End Source File
# Begin Source File

SOURCE=.\src\august\AugustGraphicsManager.h
# End Source File
# Begin Source File
...
SOURCE=.\src\august\AugustWindow2.h
# End Source File
# Begin Source File

SOURCE=.\src\august\mglaugust2.h
# End Source File
# End Group
# Begin Source File
...
SOURCE=.\src\august\mglaugust1.h
# End Source File
# End Group
